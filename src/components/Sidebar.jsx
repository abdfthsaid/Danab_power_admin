      ...
      <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button 
            ...
            className="lg:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg p-2"
          >
      ...
      <nav className="p-4 h-[calc(100%-64px)] overflow-y-auto">
        {navigationItems.map((section) => (
          <div key={section.section} className="mb-6">
            <h2 className="text-xs uppercase font-semibold text-gray-500 dark:text-gray-400 mb-2">
              {section.section}
            </h2>
